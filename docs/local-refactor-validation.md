...
`global.json` selected SDK `10.0.302` from the user-local installation at `C:\Users\mez\.dotnet`. The validation process used:

```powershell
$env:DOTNET_ROOT = 'C:\Users\mez\.dotnet'
$env:PATH = "$env:DOTNET_ROOT;$env:PATH"
```

PowerShell integration tests used the bundled `pwsh.exe` 7.6.5 under `C:\Users\mez\.cache\codex-runtimes\codex-primary-runtime\dependencies\native\powershell`. SQL Server tests used the available `MSSQLLocalDB` instance and their disposable database setup.

## Results

| Check | Result | Evidence |
| --- | --- | --- |
| `dotnet tool restore` | Pass | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-dotnet-tool-restore.log` |
| `dotnet restore` | Pass | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-dotnet-restore.log` |
| `dotnet build --configuration Release` | Pass; 0 warnings, 0 errors | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-corrected-dotnet-build-release.log` |
| `dotnet test --configuration Release --no-build` | Pass; 742 passed, 0 failed, 0 skipped | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-corrected-dotnet-test-release-no-build.log` |
| `dotnet format --verify-no-changes` | Pass | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-corrected-dotnet-format-verify.log` |
| EF pending-model check | Pass; no pending model changes | `C:\Users\mez\AppData\Local\Temp\wsr-validation-20260906\final-dotnet-ef-pending-model.log` |
