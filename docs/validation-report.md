...
- Worker focused suite: 33 passed, 0 failed, 0 skipped. Coverage includes empty/persistence backoff separation and reset, jitter bounds, handler registry, zero-handler behavior, supported-kind filtering, concurrency, completion slot release, observed exception/cancellation, renewal, lost-lease cancellation, invariant release, shutdown drain/completion/timeout, heartbeat fatality policy, and validated backoff bounds.
